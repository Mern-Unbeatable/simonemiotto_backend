...
const GALLERY = [
  ...
  {
    email: 'alessandro.verdi@example.com',
    photos: ['https://images.unsplash.com/photo-1582719471384-894fbb16e074?w=800&q=80'],
  },
  {
    email: 'giulia.neri@example.com',
    photos: [
  ...
  {
    email: 'francesco.esposito@example.com',
    photos: ['https://images.unsplash.com/photo-1530497615207-64d3a683ae56?w=800&q=80'],
  },
  {
    email: 'marta.colombo@example.com',
    photos: [
  ...
  {
    email: 'alessandro.conti@example.it',
    photos: ['https://images.unsplash.com/photo-1579684385127-1ef15d558a9a?w=800&q=80'],
  },
  {
    email: 'giulia.romano@example.it',
    photos: ['https://images.unsplash.com/photo-1551190822-a9333d879b1f?w=800&q=80'],
  },
];
...
async function main() {
  ...
  for (const { email, photos } of GALLERY) {
    ...
    if (existing > 0) {
      console.log(`  ⏭️  Gallery exists: ${profile.name}`);
      continue;
    }
