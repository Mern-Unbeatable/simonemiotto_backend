...
const cittaRoutes = require('../modules/citta/citta.route');
const clinicRoutes = require('../modules/clinic/clinic.route');
const regioneRoutes = require('../modules/regione/regione.route');
const provinciaRoutes = require('../modules/provincia/provincia.route');
...
router.use('/regioni', regioneRoutes);
router.use('/province', provinciaRoutes);
router.use('/citta', cittaRoutes);
